...
function fetch() {
  $.ajax({
    type: "GET",
    url:
      "http://localhost/grosir_online/produk/list?search=" +
      $("#search").val(),
    dataType: "JSON",
    success: function (response) {
      $("#load_data").html("");
...
$(function () {
  ...
  $("#form-barang").on("submit", function (e) {
    ...
    if (!e.isDefaultPrevented()) {
      ...
      $.ajax({
        url: "http://localhost/grosir_online/produk/simpan",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function edit(id) {
  ...
  $.ajax({
    type: "GET",
    url: "http://localhost/grosir_online/produk/detail/" + id,
    dataType: "JSON",
    success: function (response) {
      if (response.status) {
...
function hapus(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        type: "GET",
        url: "http://localhost/grosir_online/produk/hapus/" + id,
        dataType: "JSON",
        success: function (response) {
          if (response.status) {
            Swal.fire({
...
function fetching_data(limit, start, search) {
  $.ajax({
    url: "http://localhost/grosir_online/produk/list",
    method: "POST",
    data: {
      limit: limit,
      start: start,
